...
var playPlaceList = [
  ...
  PlayPlace(
    ...
    imageAsset: "images/gretel-hansel.jpg",
  ),
  PlayPlace(
    name: "UNCHARTED",
    genre: "Action",
  ...
  PlayPlace(
    ...
    imageAsset: "images/great-white.jpg",
  ),
  PlayPlace(
  ...
  PlayPlace(
    ...
    imageAsset: "images/marry-me.jpg",
  ),
  PlayPlace(
    ...
    imageAsset: "images/kukira-kau-rumah.jpg",
  ),
  PlayPlace(
    name: "SCREAM",
  ...
  PlayPlace(
    ...
    imageAsset: "images/moonfall.jpg",
  ),
];
